<header
    class="ic-navbar absolute left-0 top-0 z-40 flex w-full items-center {{ request()->is('/') ? 'bg-transparent' : '!bg-red-500 !shadow-[0px_5px_16px_1px_rgba(0,_0,_0,_0.1)]' }}"
                        ...
                        <ul class="block lg:flex gap-4" role="menu" aria-label="Navigation menu">
                            <li class="group relative">
                                <a href="{{ route('home.index') }}"
                                    class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mx-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70 {{ request()->is('/') ? 'active' : '' }}"
