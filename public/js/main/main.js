...
window.addEventListener("scroll", function () {
  if (window.location.pathname === "/") {
    if (this.scrollY >= 72) {
      ...
      document.getElementById("navbar-logo-dark").classList.remove("hidden");
      document.getElementById("navbar-logo-light").classList.add("hidden");
    } else {
      navbar.classList.remove("sticky");
      document.getElementById("navbar-logo-dark").classList.add("hidden");
      document.getElementById("navbar-logo-light").classList.remove("hidden");
    }
  } else {
    if (this.scrollY >= 72) {
      navbar.classList.add("sticky");
